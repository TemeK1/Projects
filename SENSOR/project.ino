...
const char* ssid     = "Kotikolo"; //Wifi SSID
const char* password = "K0t!k0l0puu"; //Wifi Password
const char* firstSensorApi = "LRjYi2K36hDd8VDICANWXYSBd1ja6bGi";      // API KEY IN
const char* secondSensorApi = "Yxm0S3v3nPBGcQtY7AVhEyDJZD0d2KQM";      // API KEY IN
